...
//    });
    ...
    function create_profile() {
        ...
        form.addEventListener("submit", function (event) {
            ...
            newKidDiv.addEventListener("click", function () {
                edit_profile(newKidDiv);
            });
    ...
    function edit_profile(profile) {
        ...
        firstNameInput.value = profile.querySelector("p").textContent.split(" ")[0];
        lastNameInput.value = profile.querySelector("p").textContent.split(" ")[1];
        ...
        form.addEventListener("submit", function (event) {
            ...
            var this_kid = profile.querySelector(".kids_profile p");
